...
if __name__ == "__main__":
    ...
    parser.add_argument("--device", type=str, default="cpu", choices=["cpu","cuda","cuda:0","cuda:1"], help="run device (cpu | cuda)")
    ...
    logging.info(f"Clients' learning rate: {args.learning_rate}")
    logging.info("=" * 80)
